...
def run(mode, run_config):
    ...
    if mode == 'train':
        ...
        train_input_fn, train_input_hook = data_loader.get_dataset_batch(train_data, buffer_size=5000,
                                                                         ...
                                                                         scope="val")
        val_input_fn, val_input_hook = data_loader.get_dataset_batch(val_data, batch_size=10, scope="val")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', type=str, default='train', choices=['train', 'eval'],
                        help='Mode (train)')
    parser.add_argument('--config', type=str, default='config/cnn-bilstm-crf.yml', help='config file name')
